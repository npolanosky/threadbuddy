...
const STI_UN_SIZES: Array<[string, number, number]> = [
  ...
  ["#12-24", numDia(12), 24], ["1/4-20", 0.25, 20], ["1/4-28", 0.25, 28],
  ["5/16-18", 0.3125, 18], ["5/16-24", 0.3125, 24], ["3/8-16", 0.375, 16],
  ["3/8-24", 0.375, 24], ["7/16-14", 0.4375, 14], ["7/16-20", 0.4375, 20],
  ["1/2-13", 0.5, 13], ["1/2-20", 0.5, 20], ["9/16-12", 0.5625, 12],
  ["9/16-18", 0.5625, 18], ["5/8-11", 0.625, 11], ["5/8-18", 0.625, 18],
  ["3/4-10", 0.75, 10], ["3/4-16", 0.75, 16], ["7/8-9", 0.875, 9],
  ["7/8-14", 0.875, 14], ["1-8", 1.0, 8], ["1-12", 1.0, 12],
];
...
// Kept as two arrays (series "coarse"/"fine") so the size dropdown can group them under headings.
const STI_M_COARSE_SIZES: Array<[string, number, number]> = [
...
const STI_M_FINE_SIZES: Array<[string, number, number]> = [
...
export const CATALOG: CatalogEntry[] = [
  ...
  ...metricFamilyEntries("STI_M", "coarse", STI_M_COARSE_SIZES),
  ...metricFamilyEntries("STI_M", "fine", STI_M_FINE_SIZES),
];
